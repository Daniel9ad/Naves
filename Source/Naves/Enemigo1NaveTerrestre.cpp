...
#include "Enemigo1NaveTerrestre.h"

AEnemigo1NaveTerrestre::AEnemigo1NaveTerrestre()
{
	// Inicializacion
	Velocidad = 500.0f;
	Energia = 100.0f;
...
void AEnemigo1NaveTerrestre::Tick(float DeltaTime)
{
	// Almacena en MoveDirection la direccion de movimiento
	const FVector MoveDirection = FVector(0, y, 0.f).GetClampedToMaxSize(1.0f);
